...
import { getAllEmployees } from '../../../../actions/settings/get-all-employees'
        ...
        >
...

            {
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <NoticeScreen title={'Sin empleados'} message={'Puedes agregar alguno!'} />
                    }
                />
            ...
            />
...

             {
                    showDeleteConfirm &&
                    <ConfirmationModal
                      onAccepted={() => deleteAdminMutation.mutate(employeeId)}
                      onCancel={() => { 
                        setShowDeleteConfirm(false) ;
                        setEmployeeId('');
                    }}
